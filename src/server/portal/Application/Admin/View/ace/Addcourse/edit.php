        ...
        <div class="col-xs-12 col-sm-6 widget-container-span ui-sortable" >
			...
			<input type="hidden" name="order_id" value="{$order.order_id}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" name="course_amount" value="{$order.course_amount}" id="course_amount" class="width-100" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" name="course_price" value="{$order.course_price}" id="course_price" class="width-100" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-4">
