		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-5">
				<select name="star">
					...
					<option value="2" <?php echo $data['star']=='2'?'selected':''?> >2星</option>
					<option value="3" <?php echo $data['star']=='3'?'selected':''?> >3星</option>
					<option value="4" <?php echo $data['star']=='4'?'selected':''?> >4星</option>
					<option value="5" <?php echo $data['star']=='5'?'selected':''?> >5星</option>
				</select>
			</div>
