                ...
                <form class="search-form">
                    <div class="col-sm-12">
                        ...
                        <label>年龄 (月)&nbsp;
                            ...
                            <label>月份
                                <?php
 $month_list = [ 0=>'--请选择月份--', '01'=>'一月', '02'=>'二月', '03'=>'三月', '04'=>'四月', '05'=>'五月', '06'=>'六月', '07'=>'七月', '08'=>'八月', '09'=>'九月', '10'=>'十月', '11'=>'十一月', '12'=>'十二月', ]; echo form_dropdown('month',$month_list,I('month')); ?>
                            </label>
                    </div>
                    <div class="col-sm-12">
                        <label>课程名称
	...
	<script type="text/javascript">
    //导航高亮
    highlight_subnav('<?php echo U('attend/index');?>');
	</script>
