            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="search-form">
                        <label>
                            <a class="btn btn-sm btn-primary" href="<?php echo U('Model/add');?>"><i class="icon-plus"></i>新增</a>
                        </label>
                        <label>
                            <a class="btn btn-sm btn-pink" href="<?php echo U('Model/generate');?>"><i class="icon-beaker"></i>生成</a>
                        </label>
                        <label>
	                        <button class="btn btn-sm btn-success ajax-post" target-form="ids" url="<?php echo U('Model/setStatus',array('status'=>1));?>">
                                <i class="icon-ok"></i>启 用
	                        </button>
                        </label>
                        <label>
	                        <button class="btn btn-sm btn-inverse ajax-post" target-form="ids" url="<?php echo U('Model/setStatus',array('status'=>0));?>">
