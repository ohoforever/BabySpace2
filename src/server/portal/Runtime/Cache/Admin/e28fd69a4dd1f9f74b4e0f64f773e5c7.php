...
<html lang="cn">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form action="" class="search-form">
                        <?php if(empty($model["extend"])): ?><label>
                            <a class="btn btn-sm btn-primary" href="<?php echo U('add?model='.$model['id']);?>"><i class="icon-plus"></i>新增</a>
                        </label>
                        <label>
                            <button class="btn btn-sm btn-inverse ajax-post confirm" target-form="ids" url="<?php echo U('del?model='.$model['id']);?>">
                        ...
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" id="search-btn" id="search" url="<?php echo U('Think/lists','model='.$model['name'],false);?>">
    ...
    <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
            ...
            <?php if(is_array($list_grids)): $i = 0; $__LIST__ = $list_grids;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$grid): $mod = ($i % 2 );++$i;?><td><?=get_list_field($data,$grid)?></td><?php endforeach; endif; else: echo "" ;endif; ?>
