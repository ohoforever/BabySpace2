...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/Public/Ace/css/bootstrap.min.css" rel="stylesheet" />
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    <img alt="" src="/Public/Admin/images/login_logo.png" style="margin-bottom: 6px;">
                                    <span class="white"><?php echo C('WEB_SITE_TITLE');?></span>
                                </h1>
                                        ...
                                        <div class="widget-main">
                                            ...
                                            <form action="<?php echo U('login');?>" method="post">
                                                <fieldset>
                                                    ...
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <img class="verifyimg reloadverify" style="width: 100%" src="<?php echo U('Public/verify');?>" title="看不清，点击换一张">
                                                        </span>
                                                    </label>
                                ...
                                <div id="signup-box" class="signup-box widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form action="<?php echo U('login2');?>" method="post">
                                                <fieldset>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input type="text" class="form-control mobile" maxlength="11" autocomplete="off" placeholder="请填写手机号码" name="username">
		...
		$(function(){
            ...
            $(".get-sms-code").click(function(){
                ...
                if(/^1\d{10}$/.test(mobile)){
                    $.post("<?php echo U('getAuthCode');?>",{mobile:mobile}).done(function(resp){
                        if(resp.status == 1){
            ...
            var src = '/Public/Ace/images/background/'+list[ranNum];
            $.get(src,function(){
