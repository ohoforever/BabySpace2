        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="search-form">
                    <label>
                        <a class="btn btn-sm btn-primary" href="<?php echo U('add','pid='.$pid);?>"><i class="icon-plus"></i>新增</a>
                    </label>
                    <label>
                        <a class="btn btn-sm btn-success list_sort" href="<?php echo U('sort',array('pid'=>I('get.pid',0)),'');?>"><i class="icon-ok"></i>排序</a>
                    </label>
                </div>  
            </div>
        </div>
