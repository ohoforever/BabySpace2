<?php if (!defined('THINK_PATH')) exit();?><div class="col-sm-<?php echo ($addons_config["width"]); ?>">
    <div class="widget-box transparent">
        <div class="widget-header widget-header-flat">
			<h4 class="lighter">
			    <i class="icon-exclamation-sign orange"></i><?php echo ($addons_config["title"]); ?>
		    </h4>
        </div>
            ...
            <div class="comments" style="width: auto;">
                ...
                <div class="itemdiv commentdiv">
                    ...
                    <div class="body">
                        ...
                        <div class="text">
                            <i class="icon-quote-left"></i><?php echo (PHP_OS); ?>
                        </div>
                    </div>
                </div>
                <div class="itemdiv commentdiv">
                    ...
                    <div class="body">
                        ...
                        <div class="text">
                            <i class="icon-quote-left"></i><?php echo ($_SERVER['SERVER_SOFTWARE']); ?>
                        </div>
                    </div>
                </div>
                <div class="itemdiv commentdiv">
                    ...
                    <div class="body">
                        ...
                        <div class="text">
                            ...
                            <?php  $system_info_mysql = M()->query("select version() as v;"); echo $system_info_mysql[0]['v']; ?>
                        </div>
                    </div>
                </div>
                <div class="itemdiv commentdiv">
