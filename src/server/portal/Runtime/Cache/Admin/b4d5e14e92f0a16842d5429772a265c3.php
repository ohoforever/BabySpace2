...
<html lang="cn">
            ...
            <div class="tab-pane active tab1" id="tab1">
                <div class="form-group cf">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="line-height-2 blue"><?php echo ($data['title']); ?></div>
                ...
                <div class="form-group cf">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="line-height-2 "><?php echo ($data['question']); ?></div>
                ...
                <div class="form-group cf">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <textarea class="width-100" name="answer" ><?php echo ($data['answer']); ?></textarea>
                    </div>
                    <div class="help-block col-xs-12 col-sm-reset inline">
                    </div>
                </div>
    ...
    <script>
        //导航高亮
        highlight_subnav('<?php echo U('knowledge/bbwdlist');?>');
    </script>
