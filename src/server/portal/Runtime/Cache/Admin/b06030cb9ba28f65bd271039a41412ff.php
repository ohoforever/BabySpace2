...
<!-- 标签页导航 -->
    <div class="tabbable">
        ...
        <!-- 表单 -->
        <form class="form-horizontal" method="post" action="<?php echo U('add?model='.$model['id']);?>" id="form">
            ...
            <div class="tab-content no-border padding-24">
                ...
                <div class="tab-pane active tab1" id="tab1">
                    <div class="form-group cf">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <input type="text" value="" name="title" class="width-100">
                        </div>
                    ...
                    <div class="form-group cf">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <input type="text" value="" name="tag" class="width-100">
                        </div>
                        <div class="help-block col-xs-12 col-sm-reset inline">
                        </div>
                    </div>
                ...
                <div id="tab2" class="tab-pane tab2 active">
                    ...
                    <div class="form-group cf">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="controls">
                                ...
                                <input type="hidden" value="" id="cover_id_image1" name="image1">
                            </div>
                            <script type="text/javascript">
                                //上传图片
                                /* 初始化上传插件 */
                    ...
                    <div class="form-group cf">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="controls">
                                <div id="upload_picture_image9" class="uploadify" style="height: 30px; width: 120px;">
                ...
                <div id="tab3" class="tab-pane tab3 active">
                    ...
                    <div class="form-group cf">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <input type="text" value="" name="share_title" class="width-100">                    </div>
                        <div class="help-block col-xs-12 col-sm-reset inline">
                        </div>
                    </div>
                    ...
                    <div class="form-group cf">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <textarea class="form-control" name="share_content"></textarea>                    </div>
                        <div class="help-block col-xs-12 col-sm-reset inline">
                        </div>
                    </div>
