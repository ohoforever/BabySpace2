        ...
        <div class="dataTables_wrapper">  
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form class="search-form">
                        <label>
                            <a class="btn btn-sm btn-primary" href="<?php echo U('add',array('pid'=>I('get.pid',0)));?>"><i class="icon-plus"></i>新增</a>
                        </label>
                        <label>
                            <a class="btn btn-sm btn-success ajax-post" href="<?php echo U('import',array('pid'=>I('get.pid',0)));?>">
                                <i class="icon-ok"></i>导入
                            </a>
                        </label>
                        <label>
                            <button type="button" class="btn btn-sm btn-inverse list_sort" url="<?php echo U('sort',array('pid'=>I('get.pid',0)),'');?>">
                                <i class="icon-ban-circle"></i>排序
                            </button>
                        </label>
                        <label>
                            <button type="button" class="btn btn-sm btn-danger ajax-post confirm" target-form="ids" url="<?php echo U('del');?>">
                                <i class="icon-trash"></i>删除
                            </button>
                        </label>
                        <label>菜单名称
                            <input type="text" class="search-input" name="title" value="<?php echo I('title');?>" placeholder="请输入菜单名称">
                        </label>
                        <label>
            ...
            <table class="table table-striped table-bordered table-hover dataTable">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                        <td class="center">
                            <label>
                                <input class="ace ids" type="checkbox" name="id[]" value="<?php echo ($menu["id"]); ?>" />
                                <span class="lbl"></span>
                            </label>
                        </td>
